    ...
    return (
        <div className={styles.card}>
            ...
            <div className={styles.icon}>
                {icon === 'instagram' && <Instagram size={28} color="#ffffffff" />}
                {icon === 'github' && <Github size={28} color="#ffffffff" />}
                {icon === 'mail' && <Mail size={28} color="#ffffffff" />}
                {icon === 'linkedin' && <Linkedin size={28} color="#ffffffff" />}
